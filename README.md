...
---
## ⚖️ [SWITCH-ON: 판례 기반 AI 부동산 거래 지원 챗봇 서비스](https://github.com/leestand/SWITCH-ON)
일반인 중에서도 특히 전세사기에 노출되기 쉬운 청년과 1인 가구를 위해 설계된 **RAG 기반 법률 AI 챗봇**입니다.  
...
## 📊 [ALWS: 광진구 지역 특성을 반영한 착한가격업소 대시보드 제안](https://github.com/leestand/ALWS)
